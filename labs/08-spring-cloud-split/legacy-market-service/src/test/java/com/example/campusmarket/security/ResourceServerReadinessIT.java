...
/** 冷启动时 Eureka/JWKS 不可达必须阻止就绪和受保护请求。 */
...
@ActiveProfiles("test")
class ResourceServerReadinessIT {
    ...
    @Test
    void unavailableEurekaAndJwksKeepLegacyReadinessDown() throws Exception {
    ...
    void unavailableJwksNeverLetsProtectedApiSucceedOnColdStart() throws Exception {
        String token = TestJwtFactory.issue(USER_ID, Set.of("ROLE_ADMIN"),
