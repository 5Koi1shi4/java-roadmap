...
public interface BlobRepository {
    ...
    default boolean claimDeletion(long blobId, long generation, String objectKey, UUID cleanupToken, Duration lease) {
        throw new UnsupportedOperationException("blob cleanup claiming is not supported");
    }

    /** 删除对象后以同一 token/generation 发布 DELETED。 */
    default boolean completeDeletion(long blobId, long generation, String objectKey, UUID cleanupToken) {
